...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.github.key = Rails.application.secrets.sorcery_github_key.to_s
  config.github.secret = Rails.application.secrets.sorcery_github_secret.to_s
  config.github.callback_url = Rails.application.secrets.sorcery_github_callback_url.to_s
